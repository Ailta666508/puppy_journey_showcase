...
export function normalizeRehearsalIdempotencyKey(value: unknown): string | undefined {
...
export function rehearsalRequestFingerprint(input: RehearsalScriptInput): string {
