...
【小狗头部与身体必须与垫图一致】
- 小狗的头部造型、五官画法、耳朵形状与大小，必须与white.png（白狗）、yellow.png（黄狗）完全一致，不得自行发挥。
- 头身比、身体比例、四肢粗细与长度必须严格复刻white.png, yellow.png，与参考图保持一致。
- 线条风格：极简黑色粗线条、圆润造型、波浪轮廓线、纯白/黄色填充，全部以yellow.png为准。

【成图质量不低于图6】
- 最终成图的整体效果、构图、清晰度、线条完成度、细节丰富度必须以example.png为最低标准，不得低于图6的质量。
- 小狗在画面中的比例、与背景的融合度、光影与透视，以example.png为唯一参考标准。
